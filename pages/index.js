...
export default function Home() {
  return (
    ...
    <Layout>
      <div className="fixed bg-goldendark flex flex-grow lg:w-2/5 h-full w-full"></div>
      <div className="flex items-center justify-center bg-fixed z-10 w-full">
        <div className="grid lg:grid-cols-2 grid-cols-1 lg:gap-4 lg:max-w-screen-md lg:mx-auto mx-2 my-5">
          <div className="bg-goldenlight shadow-xl flex flex-col items-center justify-between py-5">
            <Image
            ...
            <div className="bg-white flex space-x-4 w-full justify-center py-4">
          ...
          <div className="mt-8 lg:mt-0">
            <p className="text-9xl font-semibold">Hello</p>
            <p className="font-semibold text-xl leading-5">Here is who I am and what I do</p>
            ...
            <div>
              I write about latest technologies, development and about some how-tos to help the developer community around the world. I also talk on Data Engineering groups and meetups. I have a deep passion towards clean code and efficient design techniques.
