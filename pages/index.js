        ...
        <div className="grid lg:grid-cols-2 grid-cols-1 lg:gap-4 lg:max-w-screen-md lg:mx-auto mx-2 my-5">
          <div className="bg-goldenlight shadow-xl flex flex-col items-center justify-between py-5">
            ...
            <div className="bg-white flex space-x-4 w-full justify-center py-4">
              <a href="https://www.linkedin.com/in/abhik-ghosh/" rel="nofollow noreferrer" target="_blank">
              ...
              <a href="https://twitter.com/abhik_g" rel="nofollow noreferrer" target="_blank">
              ...
              <a href="https://www.instagram.com/f5_abhik/" rel="nofollow noreferrer" target="_blank">
          ...
          <div className="mt-8 lg:mt-0">
            <p className="text-7xl font-semibold">Hello</p>
